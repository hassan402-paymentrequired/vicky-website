<x-layout.guest>
    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
            <img src="{{ asset('images/login.png') }}" alt="" class="w-full h-full object-cover">
        </div>
        ...
        flex items-center justify-center">
            ...
            <div class="w-full h-100">
                ...
                <h1 class="text-xl md:text-2xl font-bold font-mono leading-tight mt-12">Log in to your account</h1>


                <form class="mt-6" action="{{ route('login.store') }}" method="POST">
                    @csrf
                    <x-form-input label="Email Address" name="email" placeholder="Enter Email Address" />
              ...
              px-4 py-3 mt-6">Log
                ...
                <p class="mt-3">Need an account? <a href="{{ route('user.register') }}"
                        class="text-green-500 hover:text-green-700 font-semibold">Create an
                        account</a></p>
