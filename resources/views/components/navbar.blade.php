 <header class="fixed inset-x-0 top-0 z-50 backdrop-blur-lg " x-data="{ isOn: false }">
     ...
     <div :class="{ 'flex': isOn, 'hidden': !isOn }">
         <!-- Background backdrop, show/hide based on slide-over state. -->
         <div class="fixed inset-0 z-50"></div>
         <div
             class="fixed inset-y-0 h-screen right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
